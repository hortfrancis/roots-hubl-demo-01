# Roots — AI English Language Learning Demo

Deployed live at: [roots-demo-for-hubl-01.alex-hortfrancis.workers.dev](https://roots-demo-for-hubl-01.alex-hortfrancis.workers.dev/)

An AI-powered voice assistant that helps speakers of other languages practice spoken English and find local English class providers. Users interact via a hold-to-speak interface, and the assistant responds with voice. Currently supports Arabic, French, and German.

Built with React, Vite, Tailwind CSS v4, OpenAI Agents SDK & Realtime API, Cloudflare Workers, and Storybook.

This project is based on a previous prototype: [hortfrancis/conversational-gujarati-prototype-01](https://github.com/hortfrancis/conversational-gujarati-prototype-01/)
...
```bash
git clone https://github.com/hortfrancis/roots-hubl-demo-01.git
```

.. or, using the [GitHub CLI](https://cli.github.com/):

```bash
gh repo clone hortfrancis/roots-hubl-demo-01
```

### Navigate to the project directory

```bash
cd roots-hubl-demo-01
```
...
To browse components and screens in isolation:
...
This should create a new Workers deployment, available at the default URL of `https://roots-demo-for-hubl-01.<username>.workers.dev`.
...
This will redeploy your Workers instance with the OpenAI API key as an environment secret.
...
A GitHub Actions workflow (`.github/workflows/deploy.yaml`) automatically builds and deploys on every push to `main`. It can also be triggered manually from the Actions tab.

For this to work, add the following secrets to the GitHub repo (Settings → Secrets and variables → Actions):

- `CLOUDFLARE_API_TOKEN` — an API token with Workers deployment permissions
